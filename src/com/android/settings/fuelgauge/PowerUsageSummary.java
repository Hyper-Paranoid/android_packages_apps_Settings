...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    private static final String KEY_BATTERY_HEALTH_CATEGORY = "battery_health_category";
    ...
    private PreferenceCategory mBatteryHealthCat;
    @VisibleForTesting
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (!getResources().getBoolean(R.bool.config_supportBatteryHealth)) {
            getPreferenceScreen().removePreference(mBatteryHealthCat);
        }
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                BananaUtils.mccCheck(getContext()) ?
                BananaUtils.batteryTemperature(getContext(), true) + "°F" :
                BananaUtils.batteryTemperature(getContext(), false) + "°C");
